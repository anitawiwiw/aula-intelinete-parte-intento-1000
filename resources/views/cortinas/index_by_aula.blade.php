    ...
    <div class="content-area">
        <div class="historial-container">
            <div class="header-historial">
                <h1 class="historial-title">Cortinas del Aula</h1>
                <div class="historial-details">
                    <div class="details-box">
                        <span class="label">Aula:</span> {{ $aula->nombre }}
                    </div>
                    <div class="details-box">
                        <span class="label">Total de cortinas:</span> {{ $cortinas->count() }}
                    </div>
                    <div class="details-box">
                        <a href="{{ route('cortinas.createByAula', $aula->id) }}" class="create-button">
                            Registrar nueva cortina
                        </a>
                    </div>
                </div>
            </div>
                    ...
                    <tbody>
                        @forelse($cortinas as $cortina)
                            <tr>
                                ...
                                <td>
                                    <span class="estado-badge estado-{{ strtolower($cortina->estado) }}">
                                        {{ $cortina->estado }}
                                    </span>
                                </td>
                                <td>{{ $cortina->ubicacion ?? '—' }}</td>
                                <td class="acciones-cell">
                                    <a href="{{ route('cortinas.edit', $cortina) }}" class="edit-button">Editar</a>
                                    <form action="{{ route('cortinas.destroy', $cortina) }}" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas eliminar esta cortina?');">
                                        @csrf @method('DELETE')
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="no-data">No hay cortinas registradas en este aula</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>

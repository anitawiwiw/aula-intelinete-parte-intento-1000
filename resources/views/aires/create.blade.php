    ...
    <div class="form-container">
        ...
        <form action="{{ route('aires.store') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" id="marca_modelo" name="marca_modelo" value="{{ old('marca_modelo') }}" required>
            </div>
            ...
            <div class="form-group">
                ...
                <select id="estado" name="estado" required>
                    ...
                    <option value="averiado" {{ old('estado') == 'averiado' ? 'selected' : '' }}>Averiado</option>
            ...
            <div class="form-group">
                ...
                <input type="date" id="ultima_mantenimiento" name="ultima_mantenimiento" value="{{ old('ultima_mantenimiento') }}">
            </div>

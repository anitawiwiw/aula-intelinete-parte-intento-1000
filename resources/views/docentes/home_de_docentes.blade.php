...
<nav>
    <span class="admin-text">Docente</span>
...
<div class="main-container">
  <!-- Sidebar -->
  <div class="sidebar">
    <a href="{{ route('materias.create_de_profes') }}" class="sidebar-button">Materias</a>
    <a href="{{ route('reservas.create_de_docentes') }}" class="sidebar-button">Reservas</a>
  </div>
  ...
  <div class="content-area">
    ...
    <div class="container">
        ...
        <form action="{{ route('horarios.index_de_profes') }}" method="GET" class="mb-4">
...
:root {
  --color-primary: #3a6f7cff;
  --color-secondary: #7ca8b0ff;
  --color-background-main: #FDF9F5;
  --color-background-sidebar: #d3dddcff;
  --color-text-dark: #1c5557ff;
  --color-text-light: #d8e9e9ff;
}
  nav {
    margin-right: 2%;
    display: flex;
